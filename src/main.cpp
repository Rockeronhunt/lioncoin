...
unsigned int nStakeMinAge = 8 * nOneHour; // 0.33 days as zero time weight
...
void ThreadScriptCheck(void*) {
    ...
    RenameThread("LionCoin-scriptch");
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in LionCoin
...
bool CBlock::CheckBlock(bool fCheckPOW, bool fCheckMerkleRoot, bool fCheckSig) const
{
    ...
    if (fProofOfStake)
    {
        ...
        // LionCoin: check proof-of-stake block signature
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "lion";
        CTransaction txNew;
        txNew.nTime = 1510857959;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1510857959;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 2683164; // !fTestNet ? 1575379 : 46534;
		
        block.print();

        //// debug print
        //assert(block.hashMerkleRoot == uint256("0xac533b356a861dcbc685d3e614a9cafb945738d6833f182855679f2fad02057b"));
...
unsigned char pchMessageStart[4] = { 0xa4, 0xf8, 0xea, 0xe5 };
