...
void BitcoinGUI::createActions()
{
    ...
    aboutAction->setStatusTip(tr("Show information about LionCoin"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for LionCoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your LionCoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified LionCoin addresses"));
    secondAuthAction = new QAction(QIcon(":/icons/key"), tr("Second &auth..."), this);
    secondAuthAction->setStatusTip(tr("Second auth with your LionCoin addresses"));
