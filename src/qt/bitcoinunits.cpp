...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("LionCoins"));
    case mBTC: return QString(QObject::tr("Milli-LionCoins (1 / 1,000)"));
    case uBTC: return QString(QObject::tr("Micro-LionCoins (1 / 1,000,000)"));
    default: return QString("???");
    }
}
